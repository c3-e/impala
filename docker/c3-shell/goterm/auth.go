...
func exchangeCode(code string, r *http.Request) Exchange {
	...
	q.Set("code", code)
	q.Add("redirect_uri", *authCallback)
...
func verifyToken(t string) (*verifier.Jwt, error) {
	tv := map[string]string{}
        if *useNonce {
		tv["nonce"] = nonce
        } // else TODO Sean A. nonce validation does not work on cloud??
	...
	var (
		...
		// TODO Sean A. nonce validation does not work on cloud??
